<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%HttpSession hs = request.getSession();
      ...
      itemList = (List<ItemData>)hs.getAttribute("cartlist");}
      int index =0;
      int total =0;
...
<ul>
<li><img src="<%=e.getImageURL() %>"></li>
<li><a href="Item?itemcode=<%=e.getItemCode()%>"><%=e.getName() %></a></li>
<li><%=e.getPrice() %>円</li>
<li><a href="Cart?index=<%=index%>">削除</a></li>
</ul>
<%index++; }%>

<a href="buyconfirm.jsp">購入する</a>
合計金額<%=total %>円
<% } %>
</div>
