...
public class MyUpdateResult extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ud = (UserData)session.getAttribute("userdataafter");
			UserDataDTO uddto = new UserDataDTO();
			uddto = ud.userDataMapping(ud);
			UserDataDAO.getInstance().updateUser(uddto);
//			ユーザーデータが更新されたのでセッションのuserdataも更新
//			そしてヘッダーのようこそ○○さんはuserdataのnameフィールドを
//			ログインするときにセッションに格納して使っているのでそこも更新する
